...
router.get("/favorites", auth, getFavoriteCandidates); // Get favorites

router.put("/update", auth, userController.updateUserProfile); // update user info

router.post("/favorites", auth, addFavoriteCandidate); // Add to favorites
router.post("/register", userController.createUser); // Add a user

router.delete("/delete", auth, userController.deleteUser); // delete user
router.delete("/favorites", auth, removeFavoriteCandidate); // Remove from favorites
